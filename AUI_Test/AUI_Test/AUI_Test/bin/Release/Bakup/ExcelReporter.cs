...
namespace AUI_Test
{
    public class ExcelReporter : SourceFile, IReporter
    {
        ...
        {
            Name = name;
           // Create(Constants.ReportText.ReportNamePrefix + DateTime.Now.ToString(Constants.ReportText.ReportDateFormat));
            string Create = Constants.ReportText.ReportNamePrefix + DateTime.Now.ToString(Constants.ReportText.ReportDateFormat);
        ...
        public IReporter NewInstance
        {
            get
            {
                return new ExcelReporter(Parser);
            }
        }
